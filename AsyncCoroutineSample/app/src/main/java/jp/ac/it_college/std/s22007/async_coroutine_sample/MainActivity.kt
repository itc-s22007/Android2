package jp.ac.it_college.std.s22007.async_coroutine_sample
...
import jp.ac.it_college.std.s22007.async_coroutine_sample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun receiveWeatherInfo(q: String){
        lifecycleScope.launch {
            val url = "$WEATHER_INFO_URL&q=$q&aapid=$APP_ID"
