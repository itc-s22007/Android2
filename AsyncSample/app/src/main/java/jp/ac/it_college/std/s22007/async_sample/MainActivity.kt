package jp.ac.it_college.std.s22007.async_sample
...
import jp.ac.it_college.std.s22007.async_sample.databinding.ActivityMainBinding
import jp.ac.it_college.std.s22007.async_sample.databinding.RowBinding
...
class MainActivity : AppCompatActivity() {
    ...
    companion object{
        ...
        private const val WHEATHER_INFO_URL = "https://api.openweathermap.org/data/2.5/weather?lang=ja"
    ...
    private fun receiveWeatherInfo(q: String){
        val url = "$WHEATHER_INFO_URL&q=$q&appid=$APP_ID"
    ...
    private fun showWeatherInfo(result: String){
        val root = JSONObject(result) //値を取り出せるようにしている
